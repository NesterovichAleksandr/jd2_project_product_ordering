 ...
 */
@ApiModel(description = "A related party defines party or party role linked to a specific entity.")
@Validated
...
public class RelatedPartyRef {
     ...
     * @return id
     **/
    @ApiModelProperty(required = true, value = "Unique identifier of the related party")
    @NotNull
     ...
     * @return href
     **/
    @ApiModelProperty(required = true, value = "Reference of the related party, could be a party reference or a party role reference.")
    @NotNull
     ...
     * @return role
     **/
    @ApiModelProperty(required = true, value = "Role played by the related party")
    @NotNull
     ...
     * @return type
     **/
    @ApiModelProperty(value = "Indicates the base (class) type of the party.")
