...
public class POSTREQOrderItem   {
  ...
  **/
  ...
  public POSTREQOrderItem action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public POSTREQOrderItem quantity(Long quantity) {
  ...
  **/
  ...
  public POSTREQOrderItem type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public POSTREQOrderItem schemaLocation(String schemaLocation) {
  ...
  **/
  ...
  public POSTREQOrderItem appointment(AppointmentRef appointment) {
  ...
  **/
  ...
  public POSTREQOrderItem billingAccount(BillingAccountRef billingAccount) {
  ...
  **/
  ...
  public POSTREQOrderItem itemPrice(List<OrderPrice> itemPrice) {
    this.itemPrice = itemPrice;
    return this;
  }

  public POSTREQOrderItem addItemPriceItem(OrderPrice itemPriceItem) {
  ...
  **/
  ...
  public POSTREQOrderItem itemTotalPrice(List<OrderPrice> itemTotalPrice) {
    this.itemTotalPrice = itemTotalPrice;
    return this;
  }

  public POSTREQOrderItem addItemTotalPriceItem(OrderPrice itemTotalPriceItem) {
  ...
  **/
  ...
  public POSTREQOrderItem productOffering(ProductOffering productOffering) {
  ...
  **/
  ...
  public POSTREQOrderItem product(Product product) {
  ...
  **/
  ...
  public POSTREQOrderItem orderItemRelationship(List<OrderItemRelationShip> orderItemRelationship) {
    this.orderItemRelationship = orderItemRelationship;
    return this;
  }

  public POSTREQOrderItem addOrderItemRelationshipItem(OrderItemRelationShip orderItemRelationshipItem) {
  ...
  **/
  ...
  public POSTREQOrderItem qualification(List<QualificationRef> qualification) {
    this.qualification = qualification;
    return this;
  }

  public POSTREQOrderItem addQualificationItem(QualificationRef qualificationItem) {
  ...
  **/
  ...
  public POSTREQOrderItem payment(List<PaymentRef> payment) {
    this.payment = payment;
    return this;
  }

  public POSTREQOrderItem addPaymentItem(PaymentRef paymentItem) {
  ...
  **/
  ...
  public POSTREQOrderItem itemTerm(List<OrderTerm> itemTerm) {
    this.itemTerm = itemTerm;
    return this;
  }

  public POSTREQOrderItem addItemTermItem(OrderTerm itemTermItem) {
  ...
  **/
  ...
  public POSTREQOrderItem orderItem(List<OrderItem> orderItem) {
    this.orderItem = orderItem;
    return this;
  }

  public POSTREQOrderItem addOrderItemItem(OrderItem orderItemItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTREQOrderItem poSTREQOrderItem = (POSTREQOrderItem) o;
    return Objects.equals(this.id, poSTREQOrderItem.id) &&
        Objects.equals(this.action, poSTREQOrderItem.action) &&
        Objects.equals(this.quantity, poSTREQOrderItem.quantity) &&
        Objects.equals(this.type, poSTREQOrderItem.type) &&
        Objects.equals(this.schemaLocation, poSTREQOrderItem.schemaLocation) &&
        Objects.equals(this.appointment, poSTREQOrderItem.appointment) &&
        Objects.equals(this.billingAccount, poSTREQOrderItem.billingAccount) &&
        Objects.equals(this.itemPrice, poSTREQOrderItem.itemPrice) &&
        Objects.equals(this.itemTotalPrice, poSTREQOrderItem.itemTotalPrice) &&
        Objects.equals(this.productOffering, poSTREQOrderItem.productOffering) &&
        Objects.equals(this.product, poSTREQOrderItem.product) &&
        Objects.equals(this.orderItemRelationship, poSTREQOrderItem.orderItemRelationship) &&
        Objects.equals(this.qualification, poSTREQOrderItem.qualification) &&
        Objects.equals(this.payment, poSTREQOrderItem.payment) &&
        Objects.equals(this.itemTerm, poSTREQOrderItem.itemTerm) &&
        Objects.equals(this.orderItem, poSTREQOrderItem.orderItem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, action, quantity, type, schemaLocation, appointment, billingAccount, itemPrice, itemTotalPrice, productOffering, product, orderItemRelationship, qualification, payment, itemTerm, orderItem);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTREQOrderItem {\n");
